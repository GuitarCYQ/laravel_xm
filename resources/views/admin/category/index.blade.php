                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-success btn-xs" href="{{ route('admin.category.edit',['cases'=>$item->id])}}" role="button">编辑</a>
                                    <a class="btn btn-danger btn-xs" href="{{ route('admin.category.delete',['case'=>$item->id])}}" role="button">删除</a>
                                </td>
                            </tr>
                                @endforeach
                            </tbody>
