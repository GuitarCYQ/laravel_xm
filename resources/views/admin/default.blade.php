...
<head>
    ...
    <style>
        .loading{
            ...
            padding-left:60px;
            font-size:15px;
            background: rgba(0, 0, 0, 0.5) url{{asset(__ADMIN__.'/images/loading.gif')}} no-repeat 10px 50%;
            opacity: 0.7;
            z-index:9999;
...
<div class="container-scroller">
    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href=""><img src="{{asset(__ADMIN__)}}/images/logo.svg" alt="logo"/></a>
            <a class="navbar-brand brand-logo-mini" href=""><img src={{asset(__ADMIN__)}}/images/logo-mini.svg alt="logo"/></a>
        </div>
            ...
            <ul class="navbar-nav navbar-nav-right">
                ...
                <!-- <li class="nav-item dropdown">
                    <a class="nav-link count-indicator dropdown-toggle" id="messageDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                        <a href=""></a><i class="mdi mdi-email-outline"></i>
    ...
    <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
                ...
                <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"><a href="http://www.yfketang.com" target="_blank"></a><i class="mdi mdi-heart text-danger"></i></span>
            </div>
        </footer>
